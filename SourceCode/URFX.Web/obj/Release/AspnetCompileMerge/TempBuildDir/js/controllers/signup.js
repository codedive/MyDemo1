...
//    };
//  }]);
app.controller('SignupFormController', ['$scope', '$rootScope', '$location', '$timeout', 'authService', 'categoryService', 'subService', 'subCategory', 'cityService', '$state', 'planService', 'districtService','$stateParams',
function ($scope, $rootScope, $location, $timeout, authService, categoryService, subService, subCategory, cityService, $state, planService, districtService, $stateParams) {
       ...
       //alert(headers);
        ...
        //        $scope.alerts.push({ type: 'warning', msg: "Please check your email and confirm your email address." });
        //       // $scope.PaymntView();
        //        //startTimer();

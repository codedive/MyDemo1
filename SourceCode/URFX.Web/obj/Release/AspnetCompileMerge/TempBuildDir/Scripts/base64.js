...
; (function ($) {
    ...
    Plugin.btoa = cfg.encode = function (plain, utf8encode) {
        plain = cfg.raw === false || cfg.utf8encode || utf8encode ? UTF8.encode(plain) : plain;
        plain = code(plain, false, r256, b64, 8, 6);
        return plain + '===='.slice((plain.length % 4) || 4);
    };

    cfg.atob = cfg.decode = function (coded, utf8decode) {
        ...
        coded = coded.join('');
        return cfg.raw === false || cfg.utf8decode || utf8decode ? UTF8.decode(coded) : coded;
    };
}(jQuery));

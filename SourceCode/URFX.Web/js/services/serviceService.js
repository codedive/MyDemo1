...
app.factory('serviceService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', '$location', function ($http, $q, localStorageService, ngAuthSettings, $location) {
    ...
    var _getAllServices = function (serviceId) {
        ...
        $http({
            ...
            method: 'GET',
            url: serviceBase + '/api/Services/ActualServicesByServiceId/?serviceId=' + serviceId,
    ...
    var _getAllServicesByCategoryId = function (categoryId) {
        var deferred = $q.defer();
        tokenData = localStorageService.get('authorizationData');
        $http({
            method: 'GET',
            url: serviceBase + '/api/Services/ServicesByCategoryId/?categoryId=' + categoryId,
            headers: {
                'Authorization': 'Bearer ' + tokenData.token,
                'Accept-Language': ngAuthSettings.currentLanguage,
            }
    ...
    authServiceFactory.getAllServicesByCategoryId = _getAllServicesByCategoryId;

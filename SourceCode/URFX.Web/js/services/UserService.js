app.factory('userService', ['$http' ,'$q', 'localStorageService', 'ngAuthSettings', '$location', function ($http, $q, localStorageService, ngAuthSettings, $location) {
      ...
      var _getAllUsers = function () {
          ...
          $http({
              method: 'GET',
              url: serviceBase + '/api/Account/Users',
              headers: {
      ...
      var _paging = function (pagingModel) {
          ...
          $http({
              method: 'Post',
              url: serviceBase + '/api/Account/Paging',
              data: pagingModel,
              headers: {
               'Authorization': 'Bearer ' + tokenData.token,
                  'Accept-Language': ngAuthSettings.currentLanguage,

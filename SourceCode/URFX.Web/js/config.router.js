...
app.run(function ($rootScope, $state, $stateParams, authService, $translate, ngAuthSettings, $location, $cookieStore) {
      ...
      function ($stateProvider, $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              .state('serviceproviderregisteration', {
                  url: '/serviceproviderregisteration',
